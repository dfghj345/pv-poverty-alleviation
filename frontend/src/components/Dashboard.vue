      ...
      <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row items-center">
          ...
          <div class="md:w-1/2 w-full">
            <div class="rounded-xl shadow-2xl w-full h-64 md:h-80 bg-gradient-to-tr from-emerald-400 to-cyan-500 flex items-center justify-center text-white text-2xl font-bold">
              光伏航拍图占位
            </div>
          </div>
        </div>
