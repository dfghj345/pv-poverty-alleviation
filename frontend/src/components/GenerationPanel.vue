      ...
      <div class="business-card-scroll">
        ...
        <div class="mt-5 grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <div class="apple-subcard border-cyan-100/80 bg-cyan-50/60 p-3 sm:p-4 dark:border-cyan-800/30 dark:bg-cyan-900/12">
            <p class="text-xs text-slate-500 dark:text-dark-text/60">项目类型</p>
            <p class="mt-1 truncate text-lg font-semibold text-slate-900 dark:text-dark-text">{{ projectType || '全部' }}</p>
          </div>
